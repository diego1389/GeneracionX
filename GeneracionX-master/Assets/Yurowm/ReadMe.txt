...
In "Animations" folder you can find all animations for this character. You acn use that 
for creating you own animation controller, 
but at the same time you can use controllers from "Controllers" folder. There you will find a 
few different controllers - each of them created for character with different weapons. 
If you like this, check how it work in demo scene. You can find demo scene in "Demo" folder. Pay attention for "PlayerController" script.
